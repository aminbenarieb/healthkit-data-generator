...
import HealthKit
import Foundation
@testable import HealthDataGenerator

final class HealthDataGeneratorTests {
    ...
    @Test("Data Import - Health Data Profile Creation")
    func testHealthDataProfileCreation() throws {
        ...
        // Create health data profile from file
        let healthStore = HKHealthStore()
        let profile = try HealthDataProfile(healthStore: healthStore, fileAtPath: tempFile)
    ...
    func testHealthDataProfileReader() throws {
        let tempDir = FileManager.default.temporaryDirectory
        ...
        let healthStore = HKHealthStore()
        let profiles = try HealthDataProfileReader.readProfilesFromDisk(healthStore, tempDir)
    ...
    func testMissingFileImport() throws {
        ...
        do {
            ...
            let _ = try HealthDataProfile(healthStore: healthStore, fileAtPath: nonExistentURL)
