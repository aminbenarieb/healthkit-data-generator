...
//                }
            ...
            let typeMap : [HKQuantityType:HKUnit] = [HKObjectType.quantityType(forIdentifier: .bodyTemperature)! : HKUnit(from: "degC"),
                                                     HKObjectType.quantityType(forIdentifier: .stepCount)! : HKUnit(from: "count"),
                                                     HKObjectType.quantityType(forIdentifier: .distanceWalkingRunning)! : HKUnit(from: "km"),
                                                     HKObjectType.quantityType(forIdentifier: .basalEnergyBurned)! : HKUnit(from: "kcal"),
                                                     HKObjectType.quantityType(forIdentifier: .height)! : HKUnit(from: "m"),
                                                     HKObjectType.quantityType(forIdentifier: .heartRate)! : .heartRate,
                                                     HKObjectType.quantityType(forIdentifier: .bloodGlucose)! : HKUnit(from: "mg/dL"),
                                                     HKObjectType.quantityType(forIdentifier: .walkingHeartRateAverage)! : .heartRate,
                                                     HKObjectType.quantityType(forIdentifier: .bloodPressureSystolic)! : HKUnit(from: "mmHg"),
                                                     HKObjectType.quantityType(forIdentifier: .restingHeartRate)! : .heartRate,
                                                     HKObjectType.quantityType(forIdentifier: .bloodPressureDiastolic)! : HKUnit(from: "mmHg"),
                                                     HKObjectType.quantityType(forIdentifier: .oxygenSaturation)! : HKUnit(from: "%"),
                                                     HKObjectType.quantityType(forIdentifier: .numberOfTimesFallen)! : HKUnit(from: "count"),
                                                     HKObjectType.quantityType(forIdentifier: .heartRateVariabilitySDNN)! : HKUnit(from: "ms"),
                                                     HKObjectType.quantityType(forIdentifier: .activeEnergyBurned)! : HKUnit(from: "kcal"),
                                                     HKObjectType.quantityType(forIdentifier: .flightsClimbed)! : HKUnit(from: "count"),
                                                     HKObjectType.quantityType(forIdentifier: .bodyMass)! : HKUnit(from: "kg"),
                                                     HKObjectType.quantityType(forIdentifier: .bodyFatPercentage)! : HKUnit(from: "%"),
                                                     HKObjectType.quantityType(forIdentifier: .peripheralPerfusionIndex)! : HKUnit(from: "%"),
                                                     HKObjectType.quantityType(forIdentifier: .peakExpiratoryFlowRate)! : HKUnit(from: "L/min"),
                                                     HKObjectType.quantityType(forIdentifier: .respiratoryRate)! : HKUnit(from: "count/min"),
                                                     HKObjectType.quantityType(forIdentifier: .inhalerUsage)! : HKUnit(from: "count"),
                                                     HKObjectType.quantityType(forIdentifier: .forcedExpiratoryVolume1)! : HKUnit(from: "L"),
                                                     HKObjectType.quantityType(forIdentifier: .bodyMassIndex)! : HKUnit(from: "count"),
                                                     HKObjectType.quantityType(forIdentifier: .leanBodyMass)! : HKUnit(from: "kg"),
                                                     HKObjectType.quantityType(forIdentifier: .basalBodyTemperature)! : HKUnit(from: "degC")]
