...
// MARK: - Health Data Profile Importer

/// Importer for a health data profile
open class HealthDataProfileImporter {
    ...
    open func importProfile (
        ...
        onCompletion: @escaping (_ error: Error?)-> Void) {
            ...
            healthStore.requestAuthorization(toShare: HealthConstants.authorizationWriteTypes(), read: nil) {
